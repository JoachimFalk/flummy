...
class Attribute{
	...
	public:	
		...
		std::pair<std::string, std::string> getNextParameter(int pos)throw (InvalidArgumentException);
		void addNewParameter(char* newType, char* newValue);
		
		std::pair<std::string, Attribute > getNextAttribute(int pos) throw (InvalidArgumentException);
