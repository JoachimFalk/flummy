...
namespace SystemC_VPC{
   ...
   */
  RoundRobinController::RoundRobinController(AbstractController* controller) : ConfigurationScheduler(controller) {
...
//#endif //VPC_DEBUG
  ...
  /**
   * \brief Implementation of PreempetivController::addTaskToSchedule
   */
