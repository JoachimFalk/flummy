#ifndef HSCD_VPC_PREEMPTIVCONTROLLER_H_
#define HSCD_VPC_PREEMPTIVCONTROLLER_H_
...
namespace SystemC_VPC{
	...
	class PreemptivController : public AbstractController{
	...
	private:
		...
		// list containing configurations which have been preempted and need to be processed later
		std::list<Configuration* > preemptedConfs;
	...
	public:
		...
		PreemptivController(const char* name);
		      
		virtual ~PreemptivController();
		...
		*/
	 	...
	 	*/
	 	 ...
	 	 */
	 	AbstractComponent* getMappedComponent(p_struct* task);
	 	 ...
	 	 * to be simulated.
	 	 */
	 	std::pair<p_struct*, const char* > getNextTask();
...
#endif /*HSCD_VPC_PREEMPTIVCONTROLLER_H_*/
